...
public class XSimilarity {
    private static Logger log = LoggerFactory.getLogger(XSimilarity.class);
...
//          put("A16", "普京与川普通话,没有达成协议，因为他们说的是四川普通话不能参加山川普通高考");
//          put("C3", "于是，猴王便将自己的来历告诉了菩提老祖。菩提老祖又问他有没有父母和姓名，猴王说没有。菩提老祖想了想，赐给他“孙悟空”一名");
...
//        put("C3", "孙悟空每天和弟子们待在一起，打扫庭院，养花修树，挑水捡柴，学经论道，不知不觉过去了七年时间。一天，菩提老祖对孙悟空说：“‘道’字门中有三百六十旁门，只要悉心学习都可以学成正果，不知道你想学哪一门呢？”");
        put("C4", "拜师后，孙悟空跟孙菩提打扫,看起来不得不说自学一门正果更加勤奋了,蚂蝗网友");// ,还跟网友学习网游学习虚拟网络世界
//        put("C5", "赵敏说道，是成昆把张无忌打了一顿");
        put("C6", "贾基听了非常高兴，不禁念诗一首:『富士见之女，于西行妖满开之时，即幽明境分开之时，为其魂魄，归于白玉楼，尽归尘土兮");
        put("C7", "普京与克林顿,没有参与进来，因为锦苑中学司马迁和孙权不再来玩，你说是也不是宋江去了松江府还没来得及说一首");
        put("C8", "非UGC，仅用于起点的文插图的点赞功能,subtype=1");
...
//        put("D4", "“‘道’字门中有三百六十旁门，只要悉心学习都可以学成正果，不知道你想学哪一门呢？”");
        put("D5", "美猴王拜了师父孙菩提以后，必须说看起来更加勤奋地学习正果一门了,蚂蝗网友");// 从拜  自师从     ,还跟网友虚拟网络世界自学网游
//        put("D6", "是张无忌把成昆打了一顿，赵敏说道");
    ...
    public static Set<String> detailSet = ImmutableSet.of("C8","C7");// , "A14", "A15", "A16","A17"
    ...
    public static void quickSimhash(Map<String, String> text1, Map<String, String> text2) throws Exception {
        dloopBestMatchFunc("quick", text1, text2, (line1, line2) -> {
            long hs1 = HanLpSimilarity.quickSimHash(line1);
            long hs2 = HanLpSimilarity.quickSimHash(line2);
            int dis = QuickSimHash.hammingDistance(hs1, hs2);
            return 1 - 1d*dis/64;
        });
    }
    public static void tfidfSimCalcV2(Map<String, String> text1, Map<String, String> text2) throws Exception {
        dloopBestMatchFunc("idfsimsh", text1, text2, (line1, line2) -> {
...
//put("B16", "普京与川普通话,没有达成参加山川普通高考的协议，因为他们说的是四川普通话");
...
/*
hanlp:C1 -> D1 similarity: 1.0000
hanlp:C2 -> D2 similarity: 0.9063
hanlp:C3 -> D3 similarity: 0.7969
hanlp:C4 -> D3 similarity: 0.7031
hanlp:C5 -> D6 similarity: 0.8438
hanlp:C6 -> D7 similarity: 0.7656
hanlp:C7 -> D10 similarity: 0.7031
hanlp:C8 -> D9 similarity: 0.9063
hanlp:C9 -> D1 similarity: 0.7188
------------
simhash:C1 -> D1 similarity: 1.0000
simhash:C2 -> D2 similarity: 0.9531
simhash:C3 -> D3 similarity: 0.8281
simhash:C4 -> D5 similarity: 0.8438
simhash:C5 -> D6 similarity: 1.0000
simhash:C6 -> D7 similarity: 0.7656
simhash:C7 -> D8 similarity: 0.7188
simhash:C8 -> D9 similarity: 0.9063
simhash:C9 -> D10 similarity: 0.6719
------------
TFIDF: C1 -> D1 with similarity: 0.9967
TFIDF: C2 -> D2 with similarity: 0.9904
TFIDF: C3 -> D3 with similarity: 0.7936
TFIDF: C4 -> D5 with similarity: 0.8218
TFIDF: C5 -> D6 with similarity: 0.9973
TFIDF: C6 -> D7 with similarity: 0.7586
TFIDF: C7 -> D8 with similarity: 0.6934
TFIDF: C8 -> D9 with similarity: 0.9418
TFIDF: C9 -> D10 with similarity: 0.3676
*/
